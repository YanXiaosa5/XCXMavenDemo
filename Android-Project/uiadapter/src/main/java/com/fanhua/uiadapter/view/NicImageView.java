...
public class NicImageView extends AppCompatImageView {
    ...
    public NicImageView(Context context) {
        this(context, null);
    }

    public NicImageView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NicImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setBorderWidth(int borderWidth) {
        ...
        this.borderWidth = DensityUtils.dp2px(context, borderWidth);
    ...
    public void setInnerBorderWidth(int innerBorderWidth) {
        this.innerBorderWidth = DensityUtils.dp2px(context, innerBorderWidth);
        clearInnerBorderWidth();
        invalidate();
    }
    ...
    public void setCornerTopLeftRadius(int cornerTopLeftRadius) {
        this.cornerTopLeftRadius = DensityUtils.dp2px(context, cornerTopLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerTopRightRadius(int cornerTopRightRadius) {
        this.cornerTopRightRadius = DensityUtils.dp2px(context, cornerTopRightRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomLeftRadius(int cornerBottomLeftRadius) {
        this.cornerBottomLeftRadius = DensityUtils.dp2px(context, cornerBottomLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomRightRadius(int cornerBottomRightRadius) {
        this.cornerBottomRightRadius = DensityUtils.dp2px(context, cornerBottomRightRadius);
        calculateRadiiAndRectF(true);
    }
